...
local Ayatol_Korsi = "karrar alqaser develop source Keane language lua "
...
----------------------------------------------------------------------------------------------
      ...
      if not database:get('lock:add'..msg.chat_id_) then  	
local KENAE = {"وعليكم السلام والرحمه⇣😻","يمه هلا بالغالي 😻🍃","وعليكم السلام حبيبي ☺️🍃","كافي بس تسلمون 🌝💔" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "هلو" or text == "هيلو" or text == "هاي" or text == "هلاو" then
   if not database:get('lock:add'..msg.chat_id_) then     	
local KENAE = {"هلووووات  ⁽🙆‍♂✨₎ֆ","يمه هلا بالعافيه 😻🍃","لا هلا ولا مرحبه شلونك مشتاقين 😻😂","اخلاً وصخلا 😌😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
        if text == "شلونك" or text == "شلونكم" or text == "شلونج" or text == "شونج" then
        	if not database:get('lock:add'..msg.chat_id_) then
local KENAE = {"تمام وانت/ي 😘🍃","شعليك انت 🧐😂","بخير انت/ي شلونك/ج ☺️","تمام وانت/ي ‏ ᵛ͢ᵎᵖ💛﴾" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "بوت" or text == "هذا بوت" then
        	if not database:get('lock:add'..msg.chat_id_) then
local KENAE = {"عـٰٰـٰود لوتُٰي 🙀 يـٰگول بُِوت عبالـٰه طافٰـُٰي💔 ويضِٰل يمٰـٓسلت وينشٰٰر روابـٰٓط 😳🍃","كافي تره صارت ماصخه 🙁🍃","اي بوت شتريد 😤","سمعتك كافي لتلح 😡" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "غني" or text == "غنيلي" then
        	if not database:get('lock:add'..msg.chat_id_) then
local KENAE = {"شكلولك عليه كاولي 😶😂","صوتي محلو للاسف 😌💔","اشعجـب كاطع بيه ياراحتي النفسيه 😂💔","حرام  الغنا 😐🍃" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
        if text == "باي" or text == "رايح" then
        	if not database:get('lock:add'..msg.chat_id_) then
local KENAE = {"بايات 💛🍃","گلعه 😶💔","الله الله الله وياك 😻😂","ثيمالا 🌝✋🏾" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
       if text == "جاو" or text == "ججاو" then
       	if not database:get('lock:add'..msg.chat_id_) then
local KENAE = {"منو ال أجوو👀😹","جااااوات  ₎✿💥😈 ❥" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
     ...
     if not database:get('lock:add'..msg.chat_id_) then    	
local KENAE = {"نورك/ج هذا ورده 🌝🍃","بوجودك/غلا تسلم 😻✨","انت/ي اصل النور 😋🍃","عماني نورك 😣😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not database:get('lock:add'..msg.chat_id_) then local KENAE = {"مووووووووواححح💋😻","مابوس ولي😌😹","خدك/ج نضيف 😂🍃","البوسه بالف حمبي 🌝💋" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
  ...
  if not database:get('lock:add'..msg.chat_id_) then         	
local KENAE = {"عيـــب 🙀😹","شبيه امك حمبي😋🍃" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
    ...
    if not database:get('lock:add'..msg.chat_id_) then     	
local KENAE = {"شبيه الشكره ام الوصخ 🤭😹","حبيته فدوووه😻","شرايد من خالته 🤭😂","خالته تفلش 😶😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
  ...
  if not database:get('lock:add'..msg.chat_id_) then       	
local KENAE = {"تف عليك ادبسزز 😒😹","لا تتفل على وجهك 😻😹","ما اسمحلك هيلگ 😡😹","بدون تفال رجائاً 😹😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
     ...
     if not database:get('lock:add'..msg.chat_id_) then    	
local KENAE = {"كافـي ضحــك 😐","لتضحك هواي وتصير فاول 🌝😹","هذ شبي يضحك 🙀😳","اضحك هيه الدنيا خربانه 😂😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
      ...
      if not database:get('lock:add'..msg.chat_id_) then   	
local KENAE = {"لصير عصبي يرتفع ضغطـك 😌😂","صار وجه احمر مثل الطماطه 🙊😹","اوف شحلاتك وانت ضايج 😻","شبي هذا الله يستر 😼😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
        if text == "😒" or text == "😒😒" or text == "😒😒😒" or text == "😒😒😒😒" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"لضوج متسوووه 🤭😹","يمه زعلان الحلو ما يكلي مرحبا 😻😹","اعدل وجهك لا اعدله الك/ج 😼👊🏼" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "🌝" or text == "🌝🌝" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"يمه الگمر عذبني حبه 🙊😻","عو نضيف الوصخ 😹😹","طفي ضواك عميتني 😼😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "💋" or text == "💋💋" then
        if not database:get('lock:add'..msg.chat_id_) then 	
local KENAE = {"كبر 🙀 جان استحيتو 😹😹","عســـل 😋🙊" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
        if text == "💔" or text == "💔💔" then
        if not database:get('lock:add'..msg.chat_id_) then 	
local KENAE = {"شبي مكسور 😔💔","موجوع كلبي والتعب بيه 😔😹","اكل بصل وانسه الحصل 😻😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
         if text == "😻" or text == "😻😻" or text == "😍😍" or text == "😍" then
      if not database:get('lock:add'..msg.chat_id_) then    	
local KENAE = {"شوفو الحب صاعد فول 😻😹","ها ناوي تزحف 😹😹","فدوووه لهاي العيون 🙊😻" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "😐" or text == "🙂" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"شبيك حبيبي 😂💔","منور محمد الاعمى 😐😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
     ...
     if not database:get('lock:add'..msg.chat_id_) then    	
local KENAE = {"انجــب اي 😒😹","اي صحيح لا 🙊😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
...
-----------------------------------------
        if text == "ههه" or text == "هههه" or text == "ههههه" or text == "هههههه" or text == "ههههههه" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"دووم الضحكه 🙊🍃","دوم الضحكه ℡̮⇣┆👑😻⇣ۦ ٰ" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
        if text == "كيبر" or text == "keeper" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"عيون 👀 كيناي امرني 🤠🍃","اي تفضل اغاتي🌝🍃","شرايد مني 😐💔","ها حياتي😻🍃" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "اكلك" or text == "اكلج" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"اي غرد/ي دا اسمع 👂🏽😹","كول😹 (كول لو هدف)😔😹","ها حياتي 🙊" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------- 
        if text == "شبيك" or text == "شبيك انت" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"انت/ي شبيك/ج😣","مابيه شي تسلم 💋😹" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------
if text == "🌚💔" or text == "💔" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"هم اجانه محترك وجه😂♥️","هاي منو كاسر كلبك😡","اهو هم اجانه صخام🐸👌" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
---------------------------------------
if text == "فديتك" or text == "فديتج" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"ها بدت حبجيه ✨😂","لتلح عود يعني احبج🙈😹","كافي درينه مشتاقله 😒" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
---------------------------------------
if text == "😢" or text == "😢😢" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"يبجي دلوع😜😹","هاي عود انت جبير كاعد تبجي😑💔","لتلح درينه تبجي😒"}
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
--------------------------------------
if text == "ميتين" or text == "اصنام" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"علساس انت متفاعل😒😒","اي عندك اعتراض🤔","اني معليه احرسكم😎" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
------------------------------------
if text == "☺️" or text == "😊" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"عود اني حباب ونت شيطان يتعلم منك🙈😂😂","وجهك ميساعد🤢😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
if text == "اجه" or text == "اجت" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"اهو لا هلا بيه ✨😂","خي ولي مزاعله ✨😂","اهلا بيه بس اطرده اذا اجه😒😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
------------------------------------------------------------
if text == "الخميس" or text == "خميس" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"وخرو وخرو🤓 هلا بلخميس تيرارا وياي يلا😍😹","هلا بلخميس عطله وكذا ركصو يلا😍😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
-----------------------------------------
if text == "🙊" or text == "🙈" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"اول مره اشوف قرد يستحي🤔😂","ما مرجيه منك هايه صاير تستحي انته هوايه 😍😂😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
--------------------------------------
if text == "ممكن نزوج" or text == "ممكن نرتبط" then
         if not database:get('lock:add'..msg.chat_id_) then 
local KENAE = {"ها ها يمعودين احنه هنا😒😹","اعتقد اكو خاص وخطبو وهنا زفه بسيارتي🚗😂" }
send(msg.chat_id_, msg.id_, 1,''..KENAE[math.random(#KENAE)]..'', 1, 'md')
end
end
----------------------------------------------------------	   
