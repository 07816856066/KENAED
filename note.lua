...
database:sadd('Keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
 ...
 if text then 
  ...
  local hash =   'Keane:'..bot_id..'res:'..msg.chat_id_
    ...
    local user_info = database:hgetall('Keane'..bot_id.."user:"..v)
  ...
  local hash =   'Keane:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash) 
    for k,v in pairs(list) do database:del('Keane:'..bot_id..'res:'..msg.chat_id_) 
...
if value == "prore" then
function get_KeaneX(Keanex1,Keanex2,Keanex3)
